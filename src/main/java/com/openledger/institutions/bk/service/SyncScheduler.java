...
import com.openledger.institutions.bk.connector.BankConnector;
import com.openledger.institutions.bk.mapper.BankMapper;
 ...
 *
 * Can be disabled by setting sync.enabled=false in application properties.
 */
@Component
